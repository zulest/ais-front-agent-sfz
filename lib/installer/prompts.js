...
const OPTIONAL_AGENTS = [
  ...
  { name: 'AIS: normalizador de estándares front (convenciones y ADRs)', value: 'ais-normalizador-estandares-front', checked: true },
  { name: 'AIS: evaluador de calidad de specs (rúbrica go/no-go)', value: 'ais-evaluador-calidad-specs-front', checked: true },
  { name: 'AIS: trazador de cambios (audit trail completo)', value: 'ais-trazador-cambios', checked: true },
  { name: 'AIS: detector de deriva (specs desactualizadas)', value: 'ais-detector-deriva', checked: true },
  { name: 'AIS: sincronizador de tickets (AzDO/Jira/GitHub)', value: 'ais-sincronizador-tickets', checked: true },
  { name: 'AIS: generador de tests front (NUnit + checklist manual)', value: 'ais-generador-tests-front', checked: true },
  { name: 'AIS: diagnosticador de bugs front (desde evidencia visual)', value: 'ais-diagnosticador-bugs-front', checked: true },
  { name: 'AIS: clonador de funcionalidad front (formulario como plantilla)', value: 'ais-clonador-funcionalidad-front', checked: true },
];
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      ...
      choices: [
        ...
        { name: 'Sin repositorio git / no aplica', value: 'none' },
      ],
    },
    {
      ...P,
    ...
    },
    {
      ...
      message: '¿Proveedor de tickets del equipo?',
      loop: false,
      default: 'none',
      choices: [
        { name: 'Ninguno / No aplica', value: 'none' },
        { name: 'Azure DevOps', value: 'azuredevops' },
