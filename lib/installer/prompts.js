...
const OPTIONAL_AGENTS = [
  ...
  { name: 'AIS: extractor de forms WinForms (opcional)', value: 'ais-extractor-forms-winforms', checked: true },
  { name: 'AIS: mapeador Proxy→REST (opcional)', value: 'ais-mapeador-proxy-rest', checked: true },

  { name: 'AIS: maestro de datos (base de datos)', value: 'ais-data-master', checked: true },
  { name: 'AIS: sistema de diseño (tokens/temas)', value: 'ais-design-system', checked: true },
  { name: 'AIS: ayuda de agentes (analogías)', value: 'ais-agents-help', checked: true },
  { name: 'AIS: Reconstructor (reconstrucción desde specs)', value: 'ais-reconstructor', checked: true },
];
