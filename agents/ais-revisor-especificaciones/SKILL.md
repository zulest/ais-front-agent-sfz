...
description: Revisa críticamente las especificaciones generadas — encuentra inconsistencias, reclasifica confianza y genera preguntas para validación humana. Úsalo en la fase de revisión.
license: MIT
