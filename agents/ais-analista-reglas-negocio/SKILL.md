...
description: Extrae conocimiento de negocio implícito del proyecto legado — reglas, ADRs retroactivos vía Git, máquinas de estado y matriz de permisos. Úsalo en la fase de interpretación.
license: MIT
